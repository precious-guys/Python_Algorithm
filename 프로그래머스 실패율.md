...
def solution(N, stages):
    ...
    a = copy.deepcopy(counter)


    for i in counter:
        counter[i] = counter.get(i) / player
    ...
    if len(counter) < N:
        counter = list(dict.fromkeys(counter+check))
...
def solution(N, stages):
    ...
    for i in range(1, N+1):
        player -= counter[i-1]
        a[i] = counter[i]/player if player else 0
...
도움 : https://jjuyaa.tistory.com/193?category=1192783